...
/*   Updated: 2019/10/25 16:32:57 by jchiang-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) 
{
	...
	SuperTrap Sob = SuperTrap("Super");

	std::cout << "[SuperTrap] " << Sob.getName() << std::endl;
	std::cout << "[SuperTrap] " << Sob.getHitPoint() << std::endl;
	std::cout << "[SuperTrap] " << Sob.getMaxHitPoint() << std::endl;
	std::cout << "[SuperTrap] " << Sob.getEnergy() << std::endl;
	std::cout << "[SuperTrap] " << Sob.getMaxEnergy() << std::endl;
	std::cout << "[SuperTrap] " << Sob.getLevel() << std::endl;
	std::cout << "[SuperTrap] " << Sob.getMeleeAttack() << std::endl;
	std::cout << "[SuperTrap] " << Sob.getRangeAttack() << std::endl;
	std::cout << "[SuperTrap] " << Sob.getArmorReduction() << std::endl;
	Sob.meleeAttack("slime");
	Sob.rangedAttack("slime");
	Sob.ninjaShoebox("skag");
	Sob.beRepaired(99);
	Sob.takeDamage(30);
	Sob.beRepaired(99);
	Sob.ninjaShoebox("skag");
