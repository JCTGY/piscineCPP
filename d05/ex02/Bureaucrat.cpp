...
/*   Updated: 2019/10/29 22:47:06 by jchiang-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(Form const & form) {
	...
	try {
		form.execute(*this);
		std::cout << this->_name <<  "excute " << form.getName() << std::endl;
...
GradeTooHighException &Bureaucrat::GradeTooHighException::operator = (const GradeTooHighException & inputClass) { 
	if (this != &inputClass)
...
GradeTooLowException &Bureaucrat::GradeTooLowException::operator = (const GradeTooLowException & inputClass) { 
	if (this != &inputClass)
		std::exception::operator = (inputClass);
	return *this;
}
