...
/*   Updated: 2019/10/29 20:58:44 by jchiang-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(void) : _name("NAME"), _gradeSign(1), _gradeExcute(1) { 
	this->_isSigned = false;
}

Form::Form(std::string const name, const int gradeSign, const int gradeExcute)
...
Form::Form(const Form & copy) : _name(copy._name), _gradeSign(copy._gradeSign), _gradeExcute(copy._gradeExcute) {
